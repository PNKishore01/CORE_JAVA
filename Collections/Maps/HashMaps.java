...
public static void main(String[] args) {
        ...
        It does not allow duplicate keys, values might be duplicate.
        It will allow null key and null values ( Only one null key will be allowed )
        It does not follow any order of elements.
        The initial capacity of HashMap is 16 and the load factor is 0.75.
